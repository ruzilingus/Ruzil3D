...
namespace Ruzil3D.Geometry
{
	...
	public struct Plane
	{
		...
		/// <summary>
		/// Получает или задает коэффициент D из общего уравнения прямой.
		/// </summary>
		public double D;
		...
		/// <remarks>
		/// Если уравнение плоскости задано в канонической форме, то абсолютное значение функции равно кратчайшему расстоянию от точки <paramref name="point"/> до плоскости.
		...
		/// <summary>
		/// Возвращает точку пересечания плоскости и прямой.
		/// </summary>
		/// <param name="plane">Плоскость.</param>
		/// <param name="line">Прямая.</param>
		/// <returns>Точка пересечания плоскости и прямой.</returns>
